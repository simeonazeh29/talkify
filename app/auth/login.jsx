...
export default function Login() {
  ...
  const handleButtonPress = () => {
    Animated.sequence([
      ...
      if (acceptTnC) router.replace("/home");
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.topContainer}>
        ...
        <Text style={styles.subtitle}>Sign In to Talkify</Text>
      ...
      <View style={styles.inputContainer}>
        ...
        <Ionicons name="key-outline" size={22} color="#1557ff" style={styles.inputIcon} />
        <TextInput
          style={styles.input}
          placeholder=""
      ...
      <View style={styles.termsContainer}>
        ...
        >
          {acceptTnC ? (
            <FontAwesome name="check-square-o" size={24} color="#1557ff" />
          ) : (
        ...
        <Text style={styles.termsText}>
          I accept the{" "}
          <Text style={[styles.linkText, { color: "#1557ff" }]}>Terms & Conditions</Text>
           and talkify's  <Text style={[styles.linkText, { color: "#1557ff" }]}>fair use policy</Text>
        </Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  loginButtonText: { fontSize: 18, color: "#fff", fontWeight: "bold", textAlign: "center" },
